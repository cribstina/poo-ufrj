...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("O funcionário " + funcionario1.getNome() + " receberá " + funcionario1.calculaSalarioMes()
        ...
        System.out
                .println(funcionario3.getNome() + " receberá " + funcionario3.calculaSalarioMes() + " reais este mês."); // dados
                                                                                                                         // atualizados
